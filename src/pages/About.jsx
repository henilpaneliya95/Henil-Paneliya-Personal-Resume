  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I'm <strong>Henil Paneliya</strong> — an aspiring{" "}
        ...
        <p>
            4th semester IMSC Data Science student with strong interest in AI/ML. Building foundation in Python, data analysis, and machine learning. Seeking opportunities to apply skills and contribute to impactful AI solutions.
        </p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  IMSC in Data Science (5-year Integrated)
                </h4>
                <p
                  style={{
                    color: "rgba(255,255,255,0.85)",
                ...
                >
                  <strong>JG University, Gurukul Road</strong> — Ahmedabad,
                  Gujarat
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Currently in 4th Semester (Pursuing)
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>2024 – 2029</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Sankalp International School</strong> — Nikol, Ahmedabad
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Gujarat Board | Percentage: 76.86%
                </p>
